...
!        Local variables
      ...
      CASE (1) ! special contact algorithm - TUBE IN A SKIN
        CALL conta1(itask,dtcal,ttime,iwrit,velnp,maxve)
      CASE (2) ! general contact in 2-D
        CALL conta2(itask,dtcal,ttime,iwrit,velnp,maxve)
