...
!**************************************************************
   ...
   include "rdmpcr.inc"
   include "sc_beam.inc"
   include "sc_shel2.inc"
   include "sc_shel3.inc"
   include "sc_shel4.inc"
   include "sc_shel5.inc"
   include "sc_shre1.inc"
   include "sc_solid.inc"
   include "sc_solsh.inc"
   include "sc_spot.inc"
   include "sc_truss.inc"
   include "wrt_mat_db.inc"
